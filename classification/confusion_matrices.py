"""
Confusion matrices (healthy vs pre-diabetic, study_group direct) for
Model 6a (Age/Sex/Race + BMI + Wearables + CGM Metrics, no routine labs),
...
fig.tight_layout()
fig.savefig(os.path.join(OUT_DIR, "confusion_matrices.png"), dpi=200, facecolor=fig.get_facecolor())
