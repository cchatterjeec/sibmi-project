...
wearables + VIF-pruned CGM feature set, no routine labs) -- the same stage
and same CGM_FEATURES_VIF_PRUNED set as run_hba1c_regression_ablation.py /
...
def main():
    ...
    ax1.set_title(f"ElasticNet -- Model 6a HbA1c SHAP\n({len(feats)} features, no_correlated_features directory)", fontsize=11)
