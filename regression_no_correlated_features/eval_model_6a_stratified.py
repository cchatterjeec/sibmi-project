...
wearables + VIF-pruned CGM feature set, no routine labs; ElasticNet and
XGBoost) by subgroup: sex, race, BMI category, and diabetes status
(study_group). CGM features are the same 23-feature VIF<=10 set as
run_hba1c_regression_ablation.py in this directory.
