...
cumulative feature-ablation stages, plus two variants that add CGM metrics
or serum glucose directly on top of demographics + BMI + wearables
(skipping routine labs). Insulin is never used as a predictor (excluded by get_ablation_stages), and
