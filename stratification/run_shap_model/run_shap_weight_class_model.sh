...
#SBATCH -o shap_weight_class_model.out
#SBATCH -e shap_weight_class_model.err
...
/usr/bin/python3 shap_weight_class_model.py \
    --data strata_df.csv \
    --output-dir shap_weight_class_results
