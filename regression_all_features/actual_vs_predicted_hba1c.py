...
routine labs -- isolates the CGM effect on its own), ElasticNet -- R2=0.661,
per hba1c_regression_results.csv, full CGM feature catalog minus gmi_pct,
the better of the two model types at this stage (XGBoost: R2=0.635) --
