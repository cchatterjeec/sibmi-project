...
(ElasticNet, Model 6a, CGM: all features except gmi_pct), check whether
the prediction error (residual = actual -
predicted HbA1c) correlates with continuous covariates already used
elsewhere in the ablation stages (age, BMI, avg_daily_steps,
avg_sleep_minutes) -- i.e. does the model systematically over/under-predict
for older/younger, heavier/leaner, more/less active, or more/less sleep
participants, rather than being unbiased with respect to these.
